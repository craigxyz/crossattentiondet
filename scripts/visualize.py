#!/usr/bin/env python
"""
Visualization script for CrossAttentionDet dataset samples.
...
from crossattentiondet.utils.visualization import visualize_dataset_sample, VISUALIZATION_ENABLED
...
def main():
    ...
    print("=== CrossAttentionDet Dataset Visualization ===")
